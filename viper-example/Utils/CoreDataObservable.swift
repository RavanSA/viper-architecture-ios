...
// Credit: https://betterprogramming.pub/rxswift-observable-and-core-data-55ab87fc02ea
class CoreDataObservable<T>: NSObject, ObservableType, NSFetchedResultsControllerDelegate where T: NSManagedObject {
    ...
    private class FetcherDisposable: Disposable {
        ...
        init<Observer>(fetcher: CoreDataObservable,
                       observer: Observer) where Observer: ObserverType, CoreDataObservable.Element == Observer.Element {
